...
--
-- Host: 127.0.0.1
-- Generation Time: Feb 04, 2024 at 02:56 AM
...
(1, '2024-02-03', '01:15', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '8', '4', 'Feb', '2024');
...
(5, '02/04/2024', '-', '-', '1', 'Dental', 'Done'),
(6, '02/04/2024', '-', '-', '2', 'Fecalysis', 'Done'),
(7, '02/04/2024', '-', '-', '3', 'Hematology', 'Done'),
(8, '02/04/2024', '-', '-', '4', 'Xray', 'Pending'),
(9, '02/04/2024', '-', '-', '5', 'Rehabilitation', 'Done'),
(10, '02/04/2024', '-', '-', '6', 'Sputum', 'Pending'),
(11, '02/04/2024', '-', '-', '7', 'Urinalysis', 'Pending'),
(12, '02/04/2024', '-', '-', '8', 'Maternity', 'Done');
...
(3, '2024-02-04', 'Dr. Machete Lazada', 32, '1', 2, 'Feb', '2024');
...
(2, '2024-02-04', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '2024-02-04', '-', '-', '2', 3, 'Feb', '2024');
...
('1', '', '44222114', 'Ratu', '', 'Nurul', '01/01/2001', 23, 'Subang', 'Single', 'Female', '100/120', '36&deg;C', '60', '20', '50kg', '165'),
('2', '', '553221114', 'Meli', '', 'Hayati', '02/02/2001', 23, 'Subang', 'Single', 'Female', '100/120', '36&deg;C', '60', '20', '50kg', '165'),
('3', '', '4411455', 'Toibul', '', 'Khoiri', '03/03/2001', 23, 'Subang', 'Single', 'Male', '100/120', '36&deg;C', '60', '20', '50kg', '165'),
('5', '', '4656622', 'Firman', '', 'Tegar', '05/05/2001', 23, 'Subang', 'Single', 'Male', '100/120', '36&deg;C', '60', '20', '50kg', '165'),
('8', '', '567474747', 'Siti', '', 'Muslihah', '08/08/2001', 23, 'Subang', 'Single', 'Female', '100/120', '36&deg;C', '60', '20', '50kg', '165');
...
(1, 'hema', 'hema', 'Lulu', '', 'Fauziyah', 'Hematology'),
(2, 'dental', 'dental', 'Lulu', '', 'Fauziyah', 'Dental'),
(3, 'fecal', 'fecal', 'Lulu', '', 'Fauziyah', 'Fecalysis'),
(4, 'mater', 'mater', 'Lulu', '', 'Fauziyah', 'Maternity'),
(6, 'rehab', 'rehab', 'Lulu', '', 'Fauziyah', 'Rehabilitation');
...
--
ALTER TABLE `birthing`
  MODIFY `birth_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;

--
-- AUTO_INCREMENT for table `complaints`
--
ALTER TABLE `complaints`
  MODIFY `com_id` int(50) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=13;
...
--
ALTER TABLE `fecalisys`
  MODIFY `fecalisys_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;

--
-- AUTO_INCREMENT for table `hematology`
--
ALTER TABLE `hematology`
  MODIFY `hem_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
