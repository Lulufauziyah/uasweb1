...
<html lang = "en">
	...
	<div class = "well">
		...
		<a href = "view_sputum_record.php" id = "d_record" style = "float:right; margin-right:10px;" class = "btn btn-success"><span class = "glyphicon glyphicon-book"></span> SPUTUM RECORD</a>
		<br />
		<br />
		...
		<table id = "table" class = "display" cellspacing = "0" >
			...
			?>
				<tr>
					...
					<td>
						<center>
							<a href = "view_sputum.php?itr_no=<?php echo $f['itr_no']?>"class = "btn btn-sm btn-info"><span class = "glyphicon glyphicon-search"></span> VIEW DETAIL</a> 
						</center>
					</td>
				</tr>
			<?php
