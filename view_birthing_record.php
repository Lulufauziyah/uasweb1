...
<html lang = "en">
	...
	<div class = "well">
		...
		<table id = "table" cellspacing = "0" class = "display">
			...
			<tbody>
			<?php ;
				$q = $conn->query("SELECT * FROM `birthing` LEFT JOIN `itr`  ON birthing.itr_no=itr.itr_no WHERE `gender` = 'Female'");
			...
			?>
				<tr>
					...
					<td><center>
							<a href = "birthing_record.php?itr_no=<?php echo $f['itr_no']?>&birth_id=<?php echo $f['birth_id'] ?>"class = "btn btn-sm btn-info"><span class = "glyphicon glyphicon-book"></span> All Records</a>						
					</center></td>
				</tr>
			<?php
				}
