...
<html lang = "en">
	...
	<div class = "well">
		...
		<table id = "table" class = "display" cellspacing = "0" >
			...
			<?php 
				$conn = new mysqli("localhost", "root", "", "hcpms");
				$q = $conn->query("SELECT * FROM `itr` WHERE `gender` = 'Female' ORDER BY `itr_no` DESC");
			...
			?>
				<tr>
					...
					<td>
						<center>
							<a href = "view_maternity.php?itr_no=<?php echo $f['itr_no']?>"class = "btn btn-sm btn-info"><span class = "glyphicon glyphicon-search"></span> VIEW DETAIL</a> 
						</center>
					</td>
				</tr>
			<?php
