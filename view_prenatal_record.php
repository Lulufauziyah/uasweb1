...
<html lang = "en">
	...
	<div class = "well">
		...
		<table id = "table" cellspacing = "0" class = "display">
			...
			<?php 
				$conn = new mysqli("localhost", "root", "", "hcpms");
				$q = $conn->query("SELECT * FROM `prenatal` NATURAL JOIN `itr` GROUP BY `itr_no` ORDER BY `prenatal_no` DESC");
			...
			?>
				<tr>
					...
					<td><center>
							<a href = "prenatal_record.php?itr_no=<?php echo $f['itr_no']?>&prenatal_no=<?php echo $f['prenatal_no'] ?>"class = "btn btn-sm btn-info"><span class = "glyphicon glyphicon-book"></span> All Records</a> 
						</center></td>
				</tr>
			<?php
				}
	...
	<div id = "footer">
		<label class = "footer-title">&copy; Health Center Patient Record Management System 2024</label>
	</div>
	</body>
