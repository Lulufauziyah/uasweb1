...
<html lang = "en">
	...
	<div class = "well">
		...
		<a href = "view_fecalysis_record.php" id = "d_record" style = "float:right; margin-right:10px;" href = "" class = "btn btn-success"><span class = "glyphicon glyphicon-book"></span> FECALYSIS RECORD</a>
		<br />
		<br />
		...
		<table id = "table" class = "display" cellspacing = "0" >
			...
			<?php 
				$conn = new mysqli("localhost", "root", "", "hcpms");
				$q = $conn->query("SELECT * FROM `itr` ORDER BY `itr_no` ASC");
			...
			?>
				<tr>
					...
					<td>
						<center>
							<a href = "view_fecalysis.php?itr_no=<?php echo $f['itr_no']?>"class = "btn btn-sm btn-info"><span class = "glyphicon glyphicon-search"></span> VIEW DETAIL</a> 
						</center>
					</td>
				</tr>
			<?php
